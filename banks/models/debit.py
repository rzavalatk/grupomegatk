...
class Debit(models.Model):
    ...
    total = fields.Monetary(string='Total', required=True)
    ...
    rest_credit = fields.Monetary( string='Diferencia', compute=_compute_rest_credit)
    ...
    total_debitos = fields.Monetary("Total débitos", compute=_compute_rest_credit)
    total_creditos = fields.Monetary("Total créditos", compute=_compute_rest_credit)
