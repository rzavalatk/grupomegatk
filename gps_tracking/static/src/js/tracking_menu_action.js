        ...
        _finishTrip: async function () {
            ...
            self._rpc({
                ...
                self.msg = {
                    ...
                    message: `El viaje ha sido finalizado con exito a la hora: ${resultado.end_time} <\br>Tiempo usado: ${tiempo_final.horas}:${tiempo_final.minutos}:${tiempo_final.segundos}`,
                };
                self.renderElement();
                setTimeout(function () {
                    self.showMsg = false;
