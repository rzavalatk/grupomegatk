...
class Prestamos(models.Model):
    ...
    def fechainicio(self):
        pres = self.env['prestamos'].search([('company_id','=',self.company_id.id)])
        for fecha in pres:
    ...
    fecha_inicio = fields.Datetime(string='Fecha de inicio',readonly=True, required=True, states={'draft': [('readonly', False)]},)
