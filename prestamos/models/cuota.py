...
class PrestamosCuotas(models.Model):
    ...
    monto_atrasado_actual = fields.Float(string='Pago faltante',copy=False, default=0)
    monto_atrasado = fields.Float(string='Capital atrasado',copy=False, default=0)
    ...
    def validar(self):
        ...
        if self.interes_moratorio > 0 or self.pago_interes:
        ...
        if capital != 0:
            ...
            if self.saldo > 0 and abs(self.pago - self.cuota_prestamo) > 0.01:
                ...
                cuota = self.cuota_prestamo - self.gastos - self.monto_atrasado
                self.cuotas_prestamo_id._cuotas(self.saldo,tasa,cuota,0,self.monto_atrasado_actual)
