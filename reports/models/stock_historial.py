...
class StockReportHistory(models.Model):
    ...
    name = fields.Char(string="Nombre de reporte", required=True, readonly=True)
    date_from = fields.Datetime(string="Fecha inicio", required=True, readonly=True)
    date_to = fields.Datetime(string="Fecha final", required=True, readonly=True)
