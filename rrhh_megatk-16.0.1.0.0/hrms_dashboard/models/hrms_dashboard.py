...
class HrLeave(models.Model):
    _inherit = 'hr.leave'
    duration_display = fields.Char('Solicitado (días / horas)',
                                   compute='_compute_duration_display',
                                   store=True,
                                   help="Campo que permite ver la duración de la solicitud de permiso"
                                        " en días u horas dependiendo de la unidad de solicitud leave_type")


class Employee(models.Model):
    _inherit = 'hr.employee'

    birthday = fields.Date('Fecha de cumpleaños', groups="base.group_user",
                           help="Cumpleaños")
...
class BroadFactor(models.Model):
    ...
    emp_broad_factor = fields.Boolean(string="Factor amplio",
                                      help="Si se marca, se mostrará en tipo de factor amplio.")
