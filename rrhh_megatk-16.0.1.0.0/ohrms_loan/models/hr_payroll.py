...
class HrPayslipInput(models.Model):
    ...
    loan_line_id = fields.Many2one('hr.loan.line', string="Cuota del préstamo", help="Cuota del préstamo")
...
class HrPayslip(models.Model):
    ...
    def onchange_employee(self):
        ...
        self.name = _('Recibo de sueldo %s para %s') % (
    ...
    def get_inputs(self, contract_ids, date_from, date_to):
        """Esto calcula las otras entradas para el recibo de sueldo del empleado..
                           """
