...
class EmployeeController(http.Controller):
    ...
    def update_credit(self, **kwargs):
        try:
            ...
            producto_consumido = data.get('producto_consumido')
            cantidad_gastada = data.get('cantidad_gastada')

            if not card_code or new_credit is None or not producto_consumido or not cantidad_gastada:
            ...
            request.env['transaccion'].sudo().create({
